window.AppUtils = (function(){
  ...
  const rarityNames = {10:{en:'Singularity ML500',es:'Singularidad ML500',pt:'Singularidade ML500'},9:{en:'Mythical',es:'Mítico',pt:'Mítico'},8:{en:'Divine',es:'Divino',pt:'Divino'},7:{en:'Ancient Immortal',es:'Inmortal antiguo',pt:'Imortal antigo'},6:{en:'Singularity ML20',es:'Singularidad ML20',pt:'Singularidade ML20'},5:{en:'Immortal',es:'Inmortal',pt:'Imortal'},4:{en:'Ancient Legendary',es:'Legendario antiguo',pt:'Lendário antigo'},3:{en:'Legendary',es:'Legendario',pt:'Lendário'},2:{en:'Epic',es:'Épico',pt:'Épico'},1:{en:'Rare',es:'Raro',pt:'Raro'},0:{en:'Common',es:'Común',pt:'Comum'}};
  const leadingQualityWords = /^(?:Ancient|Mythical|Divine|Immortal|Legendary|Epic|Rare|Common|Singularity)\s+/i;
  function lang(){ return localStorage.getItem('tb_lang') || 'en'; }
  ...
  function descByLang(item, language){ language = language || lang(); if(language==='es') return item.descEs || item.descEn || []; if(language==='pt') return item.descPt || item.descEn || []; return item.descEn || []; }
